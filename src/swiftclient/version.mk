...
CERTIFI_VERSION = 2017.7.27.1
CERTIFI_PKG     = $(CERTIFI_NAME)-$(CERTIFI_VERSION).$(CERTIFI_SUFFIX)
CERTIFI_DIR     = $(CERTIFI_PKG:%.$(CERTIFI_SUFFIX)=%)

TAR_GZ_PKGS     = $(SOURCE_PKG) $(KEYSTONECLIENT_PKG) $(FUTURES_PKG) $(REQUESTS_PKG) $(STEVEDORE_PKG) $(POSITIONAL_PKG) $(OSLO.CONFIG_PKG) $(KEYSTONEAUTH1_PKG) $(DEBTCOLLECTOR_PKG) $(OSLO.UTILS_PKG) $(OSLO.SERIALIZATION_PKG) $(OSLO.I18N_PKG) $(BABEL_PKG) $(WRAPT_PKG) $(ISO8601_PKG) $(MONOTONIC_PKG) $(NETADDR_PKG) $(RFC3986_PKG) $(CERTIFI_PKG)
