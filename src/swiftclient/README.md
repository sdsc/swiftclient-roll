# swiftclient package README

This directoy contains the build files for the swiftclient package, which is part
of the swiftclient roll. Unique to the swiftclient roll/package is the bundled 
